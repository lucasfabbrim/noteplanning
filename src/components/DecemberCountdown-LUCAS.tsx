...
export function PricingCardLucas() {
  return (
      ...
      >
        ...
        <div className="bg-white p-6">
          ...
          <div className="text-center mb-8">
            <div className="text-base text-zinc-500 mb-1">5x</div>
            <div className="text-zinc-500 text-5xl font-bold mb-2">R$ 7,58</div>
            <div className="text-sm text-zinc-600">Ou R$ 37,90 à vista.</div>
          </div>
