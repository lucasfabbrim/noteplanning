...
import ButtonPrimaryLucas from "@/components/button-primary-lucas";
import { PricingCardLucas } from "@/components/DecemberCountdown-LUCAS";
        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            >
              ...
              <p className="pt-4 px-4 md:px-0 max-w-lg text-sm md:text-base lg:text-lg text-zinc-700/90">
