          ...
          {plans.map((plan) => (
            <div key={plan.name} className="relative">
              <motion.div
                ...
                className="h-full bg-zinc-900/50 rounded-[10px] px-6 py-6 transition-all duration-300 shadow-xl shadow-zinc-900/30"
              >
                ...
                <ul className="space-y-2 mb-8 pt-4">
                  {plan.features.map((feature, idx) => (
                    ...
                    >
                      <feature.icon className="w-4 h-4 text-rose-600 mr-3" />
                      {feature.titulo}
                    </motion.li>
                  ))}
                </ul>
                <div className="pt-2 flex flex-col text-2xl font-bold text-white mb-2 text-center justify-center items-center">
                  ...
                  <h1 className="text-base text-rose-600 font-normal">
                    Ou R$ 97,90 á vista.
                  </h1>
                </div>
              </motion.div>
